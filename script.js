...
$.getJSON("./asset/jembatan_pt.geojson", function (data) {
    L.geoJSON(data, {
...
// batas administrasi
$.getJSON("asset/admin_kelurahan_ln.geojson", function (data) {
    console.log("Loaded data:", data); // Tambahkan baris ini
    L.geoJSON(data, {
        style: {
            color: "black",
            weight: 2,
...
$.getJSON("./asset/landcover_ar.geojson", function (data) {
    L.geoJSON(data, {
